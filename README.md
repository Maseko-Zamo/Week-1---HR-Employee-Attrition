...
This project was completed as part of my **Week 1 Data Science Internship with AnalystLab Africa**.

The project focuses on **Exploratory Data Analysis (EDA)** of an HR Employee Attrition dataset using Python.
...
* Exploring the dataset structure and data types
* Creating histograms
* Creating pie charts
* Creating bar graphs
...
HTML/PDF report – Inspection and analysis report
